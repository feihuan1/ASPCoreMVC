    ...
    public class MyAppContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Item>().HasData(
                new Item { Id=4, Name="Microphone", Price=40, SeriaNumberId=10 }    
            );            

            modelBuilder.Entity<SeriaNumber>().HasData(
                new SeriaNumber { Id=10, Name="MIC150", ItemId=4 }    
            );
        ...
        public DbSet<SeriaNumber> SeriaNumbers { get; set; }
